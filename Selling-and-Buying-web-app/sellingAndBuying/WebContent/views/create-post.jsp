...
<body>
  ...
  <nav class="navbar navbar-light bg-primary">
    ...
    <span class="navbar-text mb-0 h4 mx-auto text-dark">Create Post</span>
  </nav>
  ...
  <div class="container mb-5">
    <form action="${pageContext.request.contextPath}/PostController?action=CREATE" enctype="multipart/form-data" method="POST" id="post-creation" class="mt-5" >
        ...
        <ul class="list-group shadow-lg">
            ...
            <li class="list-group-item">
                <div class="row pl-5 pt-1">
                  <div class="col-sm-4 ">
                    <label for="upload" class="text-info">upload images :</label>
                  </div>
                  <div class="col">
                    <input name="image" id="upload" type="file" multiple  >
                  </div>
                </div>
            </li>
            ...
            <li class="list-group-item ">
                <div class="row pl-5 pt-1">
                  ...
                  <div class="col">
                    <input name="desc" placeholder="description" type="text" class="form-control"/>
                  </div>
                </div>
            </li>
            ...
            <li class="list-group-item ">
                <div class="row pl-5 pt-1">
                  ...
                  <div class="col">
                    <input name="type" placeholder="ex: car,bike,land etc" type="text" class="form-control"/>
                  </div>
                </div>
            </li>
                    ...
                    <ul class="list-group shadow" id="address">
                      <li class="list-group-item ">
                        <div class="row pl-5 pt-1">
                          ...
                          <div class="col">
                            <input name="pin" placeholder="pin" type="text" class="form-control"/>
                          </div>
                        </div>
                      </li>
                      <li class="list-group-item ">
        ...
        <button type="submit" class="py-3 mt-4 btn btn-lg btn-dark btn-block">Create</button>
